  ...
  return (
    <>
      <div className="relative flex flex-col justify-center items-center w-full mt-10 lg:mt-24">
        <div className="z-10 flex flex-col justify-center items-center mt-4 w-4/5 lg:w-[55%]">
        ...
        <div className="z-10 relative bg-[#F6F5F4] mt-16 rounded-md md:rounded-lg lg:rounded-2xl w-[80%] md:w-3/4 lg:w-[65%] p-5 md:p-10">
        ...
        <div className="z-10 flex flex-col lg:flex-row justify-between items-start w-[80%] md:w-3/4 lg:w-[65%] mt-4 gap-y-4 lg:gap-y-0 gap-x-4">
        ...
        <div className="z-10 flex flex-col justify-center items-center w-[80%] md:w-3/4 lg:w-[65%] mt-10">
        ...
        <div ref={leftParallax.ref} className="hidden lg:block absolute w-1/4 top-1/4 left-0">
          <Image
        ...
        <div ref={rightParallax.ref} className="hidden lg:block absolute w-1/4 top-0 right-0">
          <Image
