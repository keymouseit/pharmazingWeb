          ...
          <Slide direction="down" triggerOnce={true}>
            ...
            <div className="flex justify-center items-center">
              ...
              {!showMenu && (
                <Link
                  href="/register"
                  className="hidden lg:block cursor-pointer no-underline text-lg bg-primary hover:bg-[#534ba2] text-white ml-2 py-[1px] px-4 rounded-lg"
                >
                  Registrieren
                </Link>
              )}
      ...
      >
        <div className="flex flex-col h-full justify-start space-y-4 pt-[55px] md:pt-[46px] px-2">
          ...
          <div className="pt-4">
            <Link
              href="/register"
              className="no-underline flex flex-col justify-center items-center py-1 cursor-pointer rounded-lg bg-primary hover:bg-[#534ba2] text-white"
            >
              <span className="text-lg text-white">Registriere</span>
            </Link>
            <Link
              href="/login"
            ...
            >
              <span className="text-lg text-black">Einloggen</span>
            </Link>
          </div>
        </div>
      </nav>
