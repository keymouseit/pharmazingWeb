...
const PreviewImage: React.FC<Props> = ({ index }: Props) => {
  ...
  const [paddingLeft, setTextPadding] = useState<number>(0);
  ...
  useEffect(() => {
    ...
    if (imageData) {
      ...
      if (imageDivRef && imageDivRef.current) {
        ...
        const imageDivWidth: number = imageDivRef.current.clientWidth * 0.35;
        setTextPadding(imageDivRef.current.clientWidth * 0.02);
        setImgWidth(imageDivWidth);
        setPaddingTop(calc);
      ...
      <div className="relative h-full w-full">
        {elements &&
          ...
          elementIdx < elements.length - 1 && (
            <div className="absolute z-10 bottom-2 close-button-position">
              <FontAwesomeIcon
        ...
        <div className="absolute z-10 top-2 close-button-position">
          <FontAwesomeIcon
            className="w-5 md:w-6 h-5 md:h-6 cursor-pointer rounded-full bg-white p-1 lg:p-2"
            icon={faClose}
            color={Colors.secondaryColor}
                  ...
                  {isChemicalCompound(
                    ...
                    <div className="flex w-[40%] justify-center">
                      ...
                      <motion.p
                        ...
                        className="absolute flex justify-center items-center w-[32%]"
                      >
