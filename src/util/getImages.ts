...
const getPTABerufImage = (idx: number) => {
  switch (idx) {
    case 1:
      return { uri: constants.cloudfrontUrl + "/tutorial/WEB/BE_PTA/2.png" };
    case 2:
      return { uri: constants.cloudfrontUrl + "/tutorial/WEB/BE_PTA/3.png" };
    case 3:
      return { uri: constants.cloudfrontUrl + "/tutorial/BE_PTA/4.png" };
    case 4:
      return { uri: constants.cloudfrontUrl + "/tutorial/WEB/BE_PTA/5.png" };
    case 5:
      return { uri: constants.cloudfrontUrl + "/tutorial/WEB/BE_PTA/6.png" };
    case 6:
      return { uri: constants.cloudfrontUrl + "/tutorial/WEB/BE_PTA/7.png" };
    case 7:
      return { uri: constants.cloudfrontUrl + "/tutorial/WEB/BE_PTA/8.png" };
    case 8:
      return { uri: constants.cloudfrontUrl + "/tutorial/WEB/BE_PTA/9.png" };
    default:
      return { uri: constants.cloudfrontUrl + "/tutorial/OTHER/empty.png" };
  }
};
...
const get_ST_PH_Image = (idx: number) => {
  switch (idx) {
    case 1:
      return { uri: constants.cloudfrontUrl + "/tutorial/WEB/ST_PH/2.png" };
    case 2:
      return { uri: constants.cloudfrontUrl + "/tutorial/WEB/ST_PH/3.png" };
    case 3:
      return { uri: constants.cloudfrontUrl + "/tutorial/ST_PH/4.png" };
    case 4:
      return { uri: constants.cloudfrontUrl + "/tutorial/WEB/ST_PH/5.png" };
    case 5:
      return { uri: constants.cloudfrontUrl + "/tutorial/WEB/ST_PH/6.png" };
    case 6:
      return { uri: constants.cloudfrontUrl + "/tutorial/WEB/ST_PH/7.png" };
    case 7:
      return { uri: constants.cloudfrontUrl + "/tutorial/WEB/ST_PH/8.png" };
    case 8:
      return { uri: constants.cloudfrontUrl + "/tutorial/WEB/ST_PH/9.png" };
    case 9:
...
const get_ST_ME_HUMAN_Image = (idx: number) => {
  switch (idx) {
    case 1:
      return { uri: constants.cloudfrontUrl + "/tutorial/WEB/ST_ME_HUMAN/2.png" };
    case 2:
      return { uri: constants.cloudfrontUrl + "/tutorial/WEB/ST_ME_HUMAN/3.png" };
    case 3:
      return { uri: constants.cloudfrontUrl + "/tutorial/ST_ME_HUMAN/4.png" };
    case 4:
      return { uri: constants.cloudfrontUrl + "/tutorial/WEB/ST_ME_HUMAN/5.png" };
    case 5:
      return { uri: constants.cloudfrontUrl + "/tutorial/WEB/ST_ME_HUMAN/6.png" };
    case 6:
      return { uri: constants.cloudfrontUrl + "/tutorial/WEB/ST_ME_HUMAN/7.png" };
    case 7:
      return { uri: constants.cloudfrontUrl + "/tutorial/WEB/ST_ME_HUMAN/8.png" };
    case 8:
      return { uri: constants.cloudfrontUrl + "/tutorial/WEB/ST_ME_HUMAN/9.png" };
    case 9:
      return { uri: constants.cloudfrontUrl + "/tutorial/WEB/ST_ME_HUMAN/10.png" };
    case 10:
